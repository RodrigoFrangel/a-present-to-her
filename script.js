...
const memorias = [
    ...
    { id: 12, data: '28/01/2022', titulo: 'A Chegada do Kira', descricao: 'Nossa família começou quando nosso menino chegou 💕. Com o rabinho torto e o pintinho no queixo... ele virou nosso bem mais precioso nesse mundo.', posicao: { top: '50%', left: '85%' }, tamanho: 'padrao' },
...
function desenharLinhasConstelacao() {
    ...
    path.getBoundingClientRect(); // Força o reflow para a animação funcionar
...
function converterData(strData) {
    if (/^\d{4}$/.test(strData)) {
        return new Date(strData, 0, 1); // Ano, Mês 0 (Jan), Dia 1
    }
